...
//@Autonomous
@Disabled
public class AutoD358_R extends LinearOpMode {
            ...
            switch (state358) {
                ...
                case DRIVE:                                    // drive to enemy crater
                    if (detected == 1) {
                        ...
                        Encoders358.Turn(lF, lB, rF, rB, 0.25, Encoders358.Direction.right, 80);
                        Encoders358.Forward(lF, lB, rF, rB, 0.25, 38);
                        Encoders358.Turn(lF, lB, rF, rB, 0.25, Encoders358.Direction.right, 30);
                    } else if (detected == 2) {
                        Encoders358.Forward(lF, lB, rF, rB, 0.25, -15);
                        Encoders358.Turn(lF, lB, rF, rB, 0.25, Encoders358.Direction.right, 90);
                        Encoders358.Forward(lF, lB, rF, rB, 0.25, 19);
                        Encoders358.Turn(lF, lB, rF, rB, 0.25, Encoders358.Direction.right, 30);
                    } else if (detected == 3) {
                        Encoders358.Forward(lF, lB, rF, rB, 0.25, -15);
                        Encoders358.Turn(lF, lB, rF, rB, 0.25, Encoders358.Direction.right, 130);
                    }
                    Encoders358.Forward(lF, lB, rF, rB, 0.25, 17);
